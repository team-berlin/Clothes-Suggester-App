...
class GetWeatherClothesUiTest {
    ...
    private lateinit var suggestClothesUseCase: SuggestClothesTemperatureUseCase
    ...
    fun setup() {
        ...
        val clothesMapper = ClothesMapperImpl()
        suggestClothesUseCase = SuggestClothesTemperatureUseCase(clothesRepository, getWeatherUseCase, clothesMapper)
        getWeatherClothesUi = GetWeatherClothesUi(viewer, suggestClothesUseCase)
    }
//
//    @Test
